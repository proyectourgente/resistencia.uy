...
function Footer() {
  return (
    <footer className="text-gradient bg-gradient-to-b from-rosado to-azul border-t shadow-sm">
      {true && <a className="no-underline " href="https://luc.com.uy">
        <div className="mx-auto p-5 w-100 font-sans text-center flex flex-col md:flex-row justify-center align-middle">
          <h1 className="text-center text-polisBlue text-xl md:text-2xl justify-center flex align-middle">
            ...
            <GiClick className="text-gray-700 mx-2 text-2xl mt-1 animate-bounce" />
          </h1>
