    ...
    return (
        <Layout>
            ...
            <div className="mt-10 md:mt-20 flex flex-col w-10/12 md:w-2/3 text-justify mx-auto my-auto h-auto">
                    ...
                    <p className="mb-1">A partir de una <a href={"https://twitter.com/raulsperoni/status/1336346053323395089?s=20"}
                                          target="_blank"
                                          rel="noopener noreferrer">conversación de twitter</a> surgió la idea de armar una web para difundir los cambios introducidos por la LUC de una manera clara y accesible.</p>
                    ...
                    <p className="mb-1">El primer paso fue <a
                        ...
                        rel="noopener noreferrer">descargar los artículos</a> de la página del IMPO recuperando además, para cada uno, el texto original.</p>
                ...
                <p className="mb-1">El proyecto es de código abierto y lo podés encontrar, revisar, copiar y modificar en <a href="https://github.com/raulsperoni/resistencia.uy" rel="noopener noreferrer" target={"_blank"}>Github</a>.</p>
                    ...
                    <p className="text-center mt-5">{new Date().getFullYear()} ✊</p>
